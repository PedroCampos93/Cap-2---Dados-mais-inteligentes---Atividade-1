...
function extrair(roteiro) {

  /**Cidades Avaliadas**/
   let pegarCidade = roteiro.split("*");
   let nomesCidades = "O nome das cidades avaliadas: " + pegarCidade[1] + ", " + pegarCidade[3] + ", " + pegarCidade[5] + ".";
   alert(nomesCidades);

  /**Roteiro A de cada cidade avaliada**/
   let pegarRoteiroA = roteiro.split("<br>");
   let listaRoteirosA = "O conteúdo do roteiro A de cada cidade avaliada: São Paulo - " + pegarRoteiroA[4] + " | " + "Las Vegas - " + pegarRoteiroA[13] + " | " + "Moscou - " + pegarRoteiroA[22] + ".";
   alert(listaRoteirosA);

  /** Quantos locais são citados no roteiro A de cada cidade **/
   let roteiroSP = pegarRoteiroA[4].split(";")
   let roteiroLA = pegarRoteiroA[13].split(";")
   let roteiroMOS = pegarRoteiroA[22].split(";")
   let quantLocais = "Quantos locais são citados no roteiro A de cada cidade: São Paulo - " + roteiroSP.length + " | Las Vegas - " + roteiroLA.length + " | Moscou - " + roteiroMOS.length + "."
  alert(quantLocais)

  /** Pontos Turísticos Localizados no Centro de São Paulo **/
   let pontosTuristicos = roteiro.split("<br>");
   let roteiroCentro = "O nome dos pontos turísticos localizados no bairro Centro da cidade de São Paulo: " + pontosTuristicos[6] + ".";
   alert(roteiroCentro);
   
  /** Pontos Turísticos Localizados em Downtown em Los Angeles **/
   let roteiroDowntown = "O nome dos pontos turísticos localizados no bairro Downtown na cidade de Los Angeles: " + pontosTuristicos[15];
